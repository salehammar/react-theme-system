...
export type ThemeTokenPath = `colors.${keyof ThemeColors}` | `spacing.${keyof ThemeSpacing}` | `typography.fontSize.${keyof ThemeTypography['fontSize']}` | `typography.fontWeight.${keyof ThemeTypography['fontWeight']}` | `shadows.${keyof ThemeShadows}` | `borderRadius.${keyof ThemeBorderRadius}`;
